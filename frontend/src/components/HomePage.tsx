...
export function HomePage() {
  ...
  const handleUpload = async () => {
    ...
    try {
      const response: UploadResponse = await uploadDatabase(file, (p) =>
        setProgress(p)
      );
    ...
    >
      <div style={{ maxWidth: "1200px", width: "100%" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "35px" }}>
          ...
          >
            A lightweight, intuitive dashboard for exploring SQLite databases
            with dynamic filtering and instant sharing capabilities!
          </p>
        </div>
        ...
        >
          ...
          >
            ...
            >
              View multiple tables simultaneously with real-time filtering
          ...
          >
            ...
            <p
              style={{ fontSize: "13px", color: "#6b7280", lineHeight: "1.5" }}
            >
              Your entire dashboard state lives in the URL. Copy and paste to
          ...
          >
            ...
            <p
              style={{ fontSize: "13px", color: "#6b7280", lineHeight: "1.5" }}
            >
              Simple, clean design. Just upload your database file and start
              exploring - zero learning curve
            </p>
          </div>
                ...
                {file ? (
                  ...
                  <>
                    <p style={{ color: "#374151", marginBottom: "5px" }}>
                      <strong>Click to select your database file</strong> or
                      drag and drop
                    </p>
      ...
      {/* Uptime Monitor Link */}
      <a
        href="https://uptime-monitor.accoumar.fr/endpoints/personal_crossfilterui"
        target="_blank"
